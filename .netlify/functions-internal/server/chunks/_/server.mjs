...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BH7qxiN1.mjs");
...
const manifest = { "c9d51a5243700889c80f82ed57a4ce74b25f188e5ebd534c9c64965dc44e8e8d": {
  ...
  importer: () => import("./start.server-funcs-CFFVV4iO.mjs")
}, "a47133f431807caf990c57bb99fe3abf7a2c7844241987f2c257059ea4d1668b": {
  functionName: "getUsers_createServerFn_handler",
  importer: () => import("./users-BlnS9Ayr.mjs")
}, "97ad6c255a2a8bba0cc5ed44f5ccad4b3846167e4494c49452292f554fcf27d1": {
  functionName: "createUser_createServerFn_handler",
  importer: () => import("./users-BlnS9Ayr.mjs")
}, "8861ae61bb27bd1a8efc7e8f06f8bb70a094669e5dea893af4008a40d1f6ecc6": {
  functionName: "updateUser_createServerFn_handler",
  importer: () => import("./users-BlnS9Ayr.mjs")
}, "bba7d69e24ea7b0f4728b4e0bb1bef4462b624d542cee6dfb43f2cd7a4ecaae4": {
  ...
  importer: () => import("./demo.punk-songs-DniJZ5N2.mjs")
}, "32e5f1dd773db80dba193f47a4b630f96e7bcfb914f172cd244fb4e0f4d9f4a8": {
  functionName: "getStudents_createServerFn_handler",
  importer: () => import("./students-CQE0G1oI.mjs")
}, "dea90d935c181152caa16e99726ca741e2d22b4228d570ec807c71cb5066ef9c": {
  functionName: "createStudent_createServerFn_handler",
  importer: () => import("./students-CQE0G1oI.mjs")
}, "30a8326ca5bebbc8cbbf7a5ef2c1d0de3a2333b435aacd2be57292983e297a62": {
  functionName: "updateStudent_createServerFn_handler",
  importer: () => import("./students-CQE0G1oI.mjs")
}, "70394260b5eb8acf3fb44e34f0a47f8714604beca58e4da14f3a52a07bf1c6c5": {
  ...
  importer: () => import("./start.server-funcs-DJHAUwKJ.mjs")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-DsRecXpl.mjs").then(function(n) {
        return n.r;
      }).then((n) => n.r);
    }
    if (startEntry === null) {
