...
import { C as Card, a as CardHeader, d as CardContent, b as CardTitle, e as CardFooter } from "./card-FDMM4CqG.mjs";
import * as React from "react";
import React__default, { isValidElement, Children, PureComponent, forwardRef, useRef, useImperativeHandle, useState, useCallback, useEffect, useMemo, cloneElement, createElement, useContext, createContext, Component } from "react";
import { c as cn, B as Button } from "./auth-client-CSQiEf28.mjs";
import { S as Separator } from "./separator-CmV3no0u.mjs";
import { D as DashboardLayout, l as DropdownMenu, m as DropdownMenuTrigger, n as DropdownMenuContent, o as DropdownMenuGroup, p as DropdownMenuItem, k as ChevronUp, j as ChevronDown, A as Avatar, g as AvatarFallback, q as ChartNoAxesCombined, T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell, C as ChevronLeft, h as ChevronRight, f as AvatarImage, B as Badge } from "./badge-CCtm9bTC.mjs";
...
import { c as createLucideIcon, T as TriangleAlert } from "./router-DsRecXpl.mjs";
...
const BadgePercent = createLucideIcon("badge-percent", __iconNode$8);
const __iconNode$7 = [
...
const CalendarX2 = createLucideIcon("calendar-x-2", __iconNode$7);
const __iconNode$6 = [
...
const CirclePercent = createLucideIcon("circle-percent", __iconNode$6);
const __iconNode$5 = [
...
function Surface(props) {
  ...
  return /* @__PURE__ */ React__default.createElement("svg", _extends$s({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ React__default.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ React__default.createElement("g", _extends$r({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ React__default.createElement("path", _extends$q({}, filteredProps, {
  ...
  return _createClass$k(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React__default.createElement("li", _extends$p({
          className,
          style: itemStyle,
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  return /* @__PURE__ */ React__default.createElement("div", _extends$o({
    className: wrapperCN,
    style: finalStyle
  ...
  var chartContent = useMemo(function() {
    ...
    return React__default.Children.map(children, function(child) {
      if (/* @__PURE__ */ React__default.isValidElement(child)) {
        return /* @__PURE__ */ cloneElement(child, _objectSpread$u({
...
var DecimalCSS = /* @__PURE__ */ (function() {
  ...
  return _createClass$g(DecimalCSS2, [{
    ...
    value: function parse(str) {
      ...
      var _ref = (_NUM_SPLIT_REGEX$exec = NUM_SPLIT_REGEX.exec(str)) !== null && _NUM_SPLIT_REGEX$exec !== void 0 ? _NUM_SPLIT_REGEX$exec : [], _ref2 = _slicedToArray$a(_ref, 3), numStr = _ref2[1], unit = _ref2[2];
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ React__default.createElement("text", _extends$n({}, filterProps(textProps, true), {
    x,
    y,
...
function getNiceTickValuesFn(_ref3) {
  ...
  if (cormin === -Infinity || cormax === Infinity) {
    var _values = cormax === Infinity ? [cormin].concat(_toConsumableArray$9(range(0, tickCount - 1).map(function() {
      return Infinity;
    }))) : [].concat(_toConsumableArray$9(range(0, tickCount - 1).map(function() {
      return -Infinity;
    })), [cormax]);
  ...
  return _createClass$f(ErrorBar2, [{
    ...
    value: function render() {
      ...
      var errorBars = data.map(function(entry) {
        ...
        return /* @__PURE__ */ React__default.createElement(Layer, _extends$m({
          className: "recharts-errorBar",
          key: "bar-".concat(lineCoordinates.map(function(c) {
            return "".concat(c.x1, "-").concat(c.x2, "-").concat(c.y1, "-").concat(c.y2);
          }))
        }, svgProps), lineCoordinates.map(function(coordinates) {
          return /* @__PURE__ */ React__default.createElement("line", _extends$m({}, coordinates, {
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ React__default.createElement("text", _extends$l({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ React__default.createElement(Text, _extends$l({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject(label)) {
    return /* @__PURE__ */ React__default.createElement(Label, _extends$l({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React__default.createElement(Layer, {
    ...
    return /* @__PURE__ */ React__default.createElement(Label, _extends$k({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject(label)) {
    return /* @__PURE__ */ React__default.createElement(LabelList, _extends$k({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ React.createElement("path", _extends$i({}, filterProps(props, false), adaptEventHandlers(props), {
...
var identity2 = function identity3(param) {
  return param;
};
...
var warn2 = function warn3(condition, format, a, b, c, d, e, f) {
    ...
    switch (args[0]) {
      ...
      default: {
        ...
        if (easing[0] === "cubic-bezier" && easing[1].split(")")[0].split(",").length === 4) {
          ...
          warn2(false, "[configBezier]: arguments should be one of oneOf 'linear', 'ease', 'ease-in', 'ease-out', 'ease-in-out','cubic-bezier(x1,y1,x2,y2)', instead received %s", args);
        }
      }
    }
  }
  warn2([x1, x2, y1, y2].every(function(num) {
  ...
  if (typeof easing === "string") {
    switch (easing) {
      ...
      default:
        ...
        warn2(false, "[configEasing]: first argument should be one of 'ease', 'ease-in', 'ease-out', 'ease-in-out','cubic-bezier(x1,y1,x2,y2)', 'linear' and 'spring', instead  received %s", args);
    }
  }
  if (typeof easing === "function") {
    return easing;
  }
  warn2(false, "[configEasing]: first argument type should be function or string, instead received %s", args);
  return null;
};
  ...
  _createClass$e(Animate2, [{
    ...
    value: function render() {
      ...
      var cloneContainer = function cloneContainer2(container) {
        ...
        var res = /* @__PURE__ */ cloneElement(container, _objectSpread$j(_objectSpread$j({}, others), {}, {
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React__default.createElement("path", _extends$h({}, filterProps(props, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ React__default.createElement(Animate, {
    ...
    }, /* @__PURE__ */ React__default.createElement("path", _extends$h({}, filterProps(props, true), {
      className: layerClass,
...
var Polygon = function Polygon2(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ React__default.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ React__default.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ React__default.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ React__default.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ React__default.createElement("path", _extends$g({}, filterProps(others, true), {
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ React.createElement("circle", _extends$f({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
var PolarRadiusAxis = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$d(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ React__default.createElement("line", _extends$d({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ React__default.createElement(Text, _extends$d({}, props, {
  ...
  return _createClass$c(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ React__default.createElement(Dot, _extends$c({
      ...
      return /* @__PURE__ */ React__default.createElement(Polygon, _extends$c({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React__default.createElement(Layer, _extends$c({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ React__default.createElement("line", _extends$c({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ React__default.createElement(Text, _extends$c({}, props, {
  ...
  return _createClass$b(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), /* @__PURE__ */ React__default.createElement(Shape, _extends$a({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ React__default.createElement(Curve, _extends$a({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ React__default.createElement(Text, _extends$a({}, props, {
...
var minPointSizeCallback = function minPointSizeCallback2(minPointSize) {
  ...
  return function(value, index) {
    ...
    !isValueNumberOrNil ? process.env.NODE_ENV !== "production" ? invariant(false, "minPointSize callback function received a value with type of ".concat(_typeof$d(value), ". Currently only numbers or null/undefined are supported.")) : invariant(false) : void 0;
    return defaultValue;
  };
};
...
var formatAxisMap2 = function formatAxisMap3(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    scale.domain(domain).range(range3);
    checkDomainOfScale(scale);
    var ticks = getTicksOfScale(scale, _objectSpread$7(_objectSpread$7({}, axis), {}, {
      realScaleType
    }));
    if (axisType === "xAxis") {
...
var useXAxisOrThrow = function useXAxisOrThrow2(xAxisId) {
  ...
  !(xAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find xAxis by id "'.concat(xAxisId, '" [').concat(_typeof$a(xAxisId), "]. ").concat(getKeysForDebug(xAxisMap))) : invariant(false) : void 0;
  return xAxis;
};
var useYAxisOrThrow = function useYAxisOrThrow2(yAxisId) {
  ...
  !(yAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find yAxis by id "'.concat(yAxisId, '" [').concat(_typeof$a(yAxisId), "]. ").concat(getKeysForDebug(yAxisMap))) : invariant(false) : void 0;
  return yAxis;
};
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ React__default.isValidElement(option)) {
    ...
    line2 = /* @__PURE__ */ React__default.createElement("line", _extends$6({}, props, {
...
var CartesianAxis = /* @__PURE__ */ (function(_Component) {
  ...
  return _createClass$4(CartesianAxis2, [{
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(option)) {
        tickItem = /* @__PURE__ */ React__default.cloneElement(option, _objectSpread$2(_objectSpread$2({}, props), {}, {
  ...
  var getFormatItems = function getFormatItems2(props, currentState) {
    ...
    graphicalItems.forEach(function(item, index) {
      ...
      var axisObj = axisComponents.reduce(function(result, entry) {
        ...
        !(axisMap && axisMap[id] || entry.axisType === "zAxis") ? process.env.NODE_ENV !== "production" ? invariant(false, "Specifying a(n) ".concat(entry.axisType, "Id requires a corresponding ").concat(
          entry.axisType,
...
const ProductInsightsCard = ({ className }) => {
  return /* @__PURE__ */ jsxs(Card, { className: cn("gap-4", className), children: [
    /* @__PURE__ */ jsxs(CardHeader, { className: "flex justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
        /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold", children: "Product insight" }),
        /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm", children: "Published on 12 MAY 2025 - 6:10 PM" })
      ] }),
      /* @__PURE__ */ jsx(
        "img",
        {
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs", children: "Product reached" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xl font-semibold", children: "21,153" })
        ] }),
        /* @__PURE__ */ jsx(ChartContainer, { config: productReachChartConfig, className: "min-h-13 max-w-18", children: /* @__PURE__ */ jsx(BarChart, { accessibilityLayer: true, data: productReachChartData, barSize: 8, children: /* @__PURE__ */ jsx(Bar, { dataKey: "reached", fill: "var(--color-reached)", radius: 2 }) }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs", children: "Order placed " }),
          /* @__PURE__ */ jsx("span", { className: "text-2xl font-semibold", children: "2,123" })
        ] }),
        /* @__PURE__ */ jsx(ChartContainer, { config: orderPlacedChartConfig, className: "min-h-13 max-w-18", children: /* @__PURE__ */ jsx(BarChart, { accessibilityLayer: true, data: orderPlacedChartData, barSize: 8, children: /* @__PURE__ */ jsx(Bar, { dataKey: "orders", fill: "var(--color-orders)", radius: 2 }) }) })
      ] })
    ] })
  ] });
};
...
const MetricsData = [
  {
    icons: /* @__PURE__ */ jsx(TrendingUp, { className: "size-5" }),
    title: "Sales trend",
    value: "$11,548"
  },
  {
    icons: /* @__PURE__ */ jsx(BadgePercent, { className: "size-5" }),
    title: "Discount offers",
    value: "$1,326"
  },
  {
    icons: /* @__PURE__ */ jsx(DollarSign, { className: "size-5" }),
    title: "Net profit",
    value: "$17,356"
  },
  {
    icons: /* @__PURE__ */ jsx(ShoppingBag, { className: "size-5" }),
    title: "Total orders",
    value: "248"
  }
];
...
const SalesMetricsCard = ({ className }) => {
  return /* @__PURE__ */ jsx(Card, { className, children: /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-7 lg:col-span-3", children: [
        /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold", children: "Sales metrics" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xl font-medium", children: "Sandy' Company" }),
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm", children: "sandy@company.com" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid gap-4 sm:grid-cols-2", children: MetricsData.map((metric, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-md border px-4 py-2", children: [
          /* @__PURE__ */ jsx(Avatar, { className: "size-8.5 rounded-sm", children: /* @__PURE__ */ jsx(AvatarFallback, { className: "bg-primary/10 text-primary shrink-0 rounded-sm", children: metric.icons }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm font-medium", children: metric.title }),
            /* @__PURE__ */ jsx("span", { className: "text-lg font-medium", children: metric.value })
          ] })
        ] }, index)) })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "gap-4 py-4 shadow-none lg:col-span-2", children: [
        /* @__PURE__ */ jsx(CardHeader, { className: "gap-1", children: /* @__PURE__ */ jsx(CardTitle, { className: "text-lg font-semibold", children: "Revenue goal" }) }),
        /* @__PURE__ */ jsx(CardContent, { className: "px-0", children: /* @__PURE__ */ jsx(ChartContainer, { config: revenueChartConfig, className: "h-38.5 w-full", children: /* @__PURE__ */ jsxs(PieChart, { margin: { top: 0, bottom: 0, left: 0, right: 0 }, children: [
        ...
        /* @__PURE__ */ jsxs(CardFooter, { className: "justify-between", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xl", children: "Plan completed" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xl font-medium", children: "56%" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Card, { className: "shadow-none", children: /* @__PURE__ */ jsxs(CardContent, { className: "grid gap-4 px-4 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center gap-6", children: [
        /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold", children: "Sales plan" }),
        /* @__PURE__ */ jsxs("span", { className: "max-lg:5xl text-6xl", children: [
          salesPlanPercentage,
          "%"
        ] }),
        /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm", children: "Percentage profit from total sales" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6 text-lg md:col-span-4", children: [
        /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Cohort analysis indicators" }),
        /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-wrap", children: "Analyzes the behaviour of a group of users who joined a product/service at the same time. over a certain period." }),
        /* @__PURE__ */ jsxs("div", { className: "grid gap-6 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(ChartNoAxesCombined, { className: "size-6" }),
            /* @__PURE__ */ jsx("span", { className: "text-lg font-medium", children: "Open Statistics" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(CirclePercent, { className: "size-6" }),
            /* @__PURE__ */ jsx("span", { className: "text-lg font-medium", children: "Percentage Change" })
          ] })
        ] }),
        /* @__PURE__ */ jsx(ChartContainer, { config: salesChartConfig, className: "h-7.75 w-full", children: /* @__PURE__ */ jsx(
          BarChart,
          {
...
const StatisticsCard = ({ icon, value, title, changePercentage, className }) => {
  return /* @__PURE__ */ jsxs(Card, { className: cn("gap-4", className), children: [
    /* @__PURE__ */ jsxs(CardHeader, { className: "flex items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-primary/10 text-primary flex size-8 shrink-0 items-center justify-center rounded-md", children: icon }),
      /* @__PURE__ */ jsx("span", { className: "text-2xl", children: value })
    ] }),
    /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsx("span", { className: "font-semibold", children: title }),
      /* @__PURE__ */ jsxs("p", { className: "space-x-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-sm", children: changePercentage }),
        /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm", children: "than last week" })
      ] })
    ] })
  ] });
};
...
const TotalEarningCard = ({ earningData: earningData2, title, earning, trend, percentage, comparisonText, className }) => {
  return /* @__PURE__ */ jsxs(Card, { className, children: [
    /* @__PURE__ */ jsxs(CardHeader, { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(Button, { variant: "ghost", size: "icon", className: "text-muted-foreground size-6 rounded-full", children: [
          /* @__PURE__ */ jsx(EllipsisVertical, {}),
          /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Menu" })
        ] }) }),
        /* @__PURE__ */ jsx(DropdownMenuContent, { align: "end", children: /* @__PURE__ */ jsx(DropdownMenuGroup, { children: listItems.map((item, index) => /* @__PURE__ */ jsx(DropdownMenuItem, { children: item }, index)) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-1 flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxs("span", { className: "text-2xl font-semibold", children: [
            "$",
            earning
          ] }),
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1", children: [
            trend === "up" ? /* @__PURE__ */ jsx(ChevronUp, { className: "size-4" }) : /* @__PURE__ */ jsx(ChevronDown, { className: "size-4" }),
        ...
        /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm", children: comparisonText })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-1 flex-col justify-evenly gap-4", children: earningData2.map((earning2, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2.5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2.5", children: [
          /* @__PURE__ */ jsx(Avatar, { className: "size-11 rounded-sm", children: /* @__PURE__ */ jsx(AvatarFallback, { className: "bg-primary/10 shrink-0 rounded-sm", children: /* @__PURE__ */ jsx("img", { src: earning2.img, alt: earning2.platform, className: "size-6" }) }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: earning2.platform }),
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm", children: earning2.technologies })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm", children: earning2.earnings }),
          /* @__PURE__ */ jsx(Progress, { value: earning2.progressPercentage, className: "w-36" })
        ] })
      ] }, index)) })
    ] })
  ] });
...
function usePagination({
  ...
  const showRightEllipsis = pages.length > 0 && pages[pages.length - 1] < totalPages && pages[pages.length - 1] < totalPages - 1;
  return {
    pages,
    showLeftEllipsis,
    showRightEllipsis
...
const columns = [
  {
    ...
    cell: ({ row }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxs(Avatar, { className: "size-9", children: [
        /* @__PURE__ */ jsx(AvatarImage, { src: row.original.avatar, alt: "Hallie Richards" }),
        /* @__PURE__ */ jsx(AvatarFallback, { className: "text-xs", children: row.original.avatarFallback })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col text-sm", children: [
        /* @__PURE__ */ jsx("span", { className: "text-card-foreground font-medium", children: row.getValue("name") }),
        /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: row.original.email })
      ] })
    ] })
  },
  {
  ...
  },
  {
    accessorKey: "status",
    header: "Status",
    cell: ({ row }) => /* @__PURE__ */ jsx(Badge, { className: "bg-primary/10 text-primary rounded-sm px-1.5 capitalize", children: row.getValue("status") })
  },
  {
    accessorKey: "paidBy",
    header: () => /* @__PURE__ */ jsx("span", { className: "w-fit", children: "Paid by" }),
    cell: ({ row }) => /* @__PURE__ */ jsx(
      "img",
      {
        src: row.getValue("paidBy") === "mastercard" ? "https://cdn.shadcnstudio.com/ss-assets/blocks/data-table/image-1.png" : "https://cdn.shadcnstudio.com/ss-assets/blocks/data-table/image-2.png",
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsx("div", { className: "border-b", children: /* @__PURE__ */ jsxs(Table, { children: [
      /* @__PURE__ */ jsx(TableHeader, { children: table.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ jsx(TableRow, { children: headerGroup.headers.map((header) => {
        return /* @__PURE__ */ jsx(TableHead, { className: "text-muted-foreground h-14 first:pl-4", children: header.isPlaceholder ? null : flexRender(header.column.columnDef.header, header.getContext()) }, header.id);
      }) }, headerGroup.id)) }),
      /* @__PURE__ */ jsx(TableBody, { children: table.getRowModel().rows?.length ? table.getRowModel().rows.map((row) => /* @__PURE__ */ jsx(TableRow, { "data-state": row.getIsSelected() && "selected", children: row.getVisibleCells().map((cell) => /* @__PURE__ */ jsx(TableCell, { className: "first:pl-4", children: flexRender(cell.column.columnDef.cell, cell.getContext()) }, cell.id)) }, row.id)) : /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: columns.length, className: "h-24 text-center", children: "No results." }) }) })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3 px-6 py-4 max-sm:flex-col md:max-lg:flex-col", children: [
      /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground text-sm whitespace-nowrap", "aria-live": "polite", children: [
        "Showing",
        " ",
      ...
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Pagination, { children: /* @__PURE__ */ jsxs(PaginationContent, { children: [
        ...
        showLeftEllipsis && /* @__PURE__ */ jsx(PaginationItem, { children: /* @__PURE__ */ jsx(PaginationEllipsis, {}) }),
        pages.map((page) => {
        ...
        showRightEllipsis && /* @__PURE__ */ jsx(PaginationItem, { children: /* @__PURE__ */ jsx(PaginationEllipsis, {}) }),
        /* @__PURE__ */ jsx(PaginationItem, { children: /* @__PURE__ */ jsxs(
          Button,
          {
            className: "disabled:pointer-events-none disabled:opacity-50",
...
function RowActions() {
  return /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsx("div", { className: "flex", children: /* @__PURE__ */ jsx(Button, { size: "icon", variant: "ghost", className: "rounded-full p-2", "aria-label": "Edit item", children: /* @__PURE__ */ jsx(EllipsisVertical, { className: "size-5", "aria-hidden": "true" }) }) }) }),
    /* @__PURE__ */ jsx(DropdownMenuContent, { align: "end", children: /* @__PURE__ */ jsxs(DropdownMenuGroup, { children: [
      /* @__PURE__ */ jsx(DropdownMenuItem, { children: /* @__PURE__ */ jsx("span", { children: "Edit" }) }),
      /* @__PURE__ */ jsx(DropdownMenuItem, { children: /* @__PURE__ */ jsx("span", { children: "Duplicate" }) }),
      /* @__PURE__ */ jsx(DropdownMenuItem, { variant: "destructive", children: /* @__PURE__ */ jsx("span", { children: "Delete" }) })
    ] }) })
  ] });
}
const StatisticsCardData = [{
  icon: /* @__PURE__ */ jsx(Truck, { className: "size-4" }),
  value: "42",
  title: "Shipped Orders",
  changePercentage: "+18.2%"
}, {
  icon: /* @__PURE__ */ jsx(TriangleAlert, { className: "size-4" }),
  value: "8",
  title: "Damaged Returns",
  changePercentage: "-8.7%"
}, {
  icon: /* @__PURE__ */ jsx(CalendarX2, { className: "size-4" }),
  value: "27",
...
const DashboardShell = () => {
  return /* @__PURE__ */ jsx(DashboardLayout, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-6 lg:grid-cols-3", children: [
    /* @__PURE__ */ jsx("div", { className: "col-span-full grid gap-6 sm:grid-cols-3 md:max-lg:grid-cols-1", children: StatisticsCardData.map((card, index) => /* @__PURE__ */ jsx(StatisticsCard, { icon: card.icon, title: card.title, value: card.value, changePercentage: card.changePercentage }, index)) }),
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 max-xl:col-span-full lg:max-xl:grid-cols-2", children: [
      /* @__PURE__ */ jsx(ProductInsightsCard, { className: "justify-between gap-3 [&>[data-slot=card-content]]:space-y-5" }),
      /* @__PURE__ */ jsx(TotalEarningCard, { title: "Total Earning", earning: 24650, trend: "up", percentage: 10, comparisonText: "Compare to last year ($84,325)", earningData, className: "justify-between gap-5 sm:min-w-0 [&>[data-slot=card-content]]:space-y-7" })
    ] }),
    /* @__PURE__ */ jsx(SalesMetricsCard, { className: "col-span-full xl:col-span-2 [&>[data-slot=card-content]]:space-y-6" }),
    /* @__PURE__ */ jsx(Card, { className: "col-span-full w-full py-0", children: /* @__PURE__ */ jsx(TransactionDatatable, { data: transactionData }) })
  ] }) });
};
