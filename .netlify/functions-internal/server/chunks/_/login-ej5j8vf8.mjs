  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-6", className), ...props, children: [
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { className: "text-center", children: [
        /* @__PURE__ */ jsx(CardTitle, { className: "text-xl", children: "Welcome back" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Login with your Apple or Google account" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(
        "form",
        {
          ...
          children: /* @__PURE__ */ jsxs(FieldGroup, { children: [
            /* @__PURE__ */ jsx(Field, { children: /* @__PURE__ */ jsxs(Button, { onClick: signIn, variant: "outline", type: "button", children: [
...
function RouteComponent() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsx("main", { className: "flex flex-col items-center justify-center pt-20", children: /* @__PURE__ */ jsx(LoginForm, {}) })
  ] });
}
export {
